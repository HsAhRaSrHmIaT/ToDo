  ...
  return (
    ...
    <div className="App">
      ...
      <ul>
          ...
          <li key={todo.id}>
            {editingId === todo.id ? (
              ...
              <>
                ...
                <div>
                  <span className='priority'><span className='dot medium'></span>medium</span>
                </div>
        ...
        {isOpen && <Popup id={popupId} content={content} handleClose={togglePopup} onSave={handleSave} completed={todos.find(todo => todo.id === popupId)?.completed} />}
      </ul>
    </div>
